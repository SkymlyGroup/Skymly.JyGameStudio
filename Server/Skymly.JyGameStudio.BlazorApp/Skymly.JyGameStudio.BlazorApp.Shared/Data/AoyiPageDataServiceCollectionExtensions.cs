...
namespace Skymly.JyGameStudio.BlazorApp.Shared.Data
{
    ...
    /// </summary>
    public static class AoyiPageDataServiceCollectionExtensions
    {
        /// <summary>
        /// 增加 PetaPoco 数据库操作服务
        /// </summary>
    ...
    /// 演示网站示例数据注入服务实现类
    /// </summary>
    internal class AoyiPageDataService<TModel> : DataServiceBase<TModel> where TModel : class, new()
    {
        ...
        public AoyiPageDataService(IStringLocalizer<Aoyi> localizer)
        {
            Localizer = localizer;
        }
